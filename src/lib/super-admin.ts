...
function parseJobRequest(job: { request_json?: string | Record<string, unknown> }): { dry_run?: boolean } {
...
function ensureProvisionArtifacts(job: { request_json?: string | Record<string, unknown>; tenant_slug?: string; linux_user?: string; openclaw_home?: string; gateway_port?: number }) {
